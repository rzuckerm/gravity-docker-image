GRAVITY_VERSION := $(shell cat GRAVITY_VERSION)
GRAVITY_DEPS := $(wildcard GRAVITY_*)
DOCKER_TAG_PREFIX := rzuckerm/gravity:$(GRAVITY_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(GRAVITY_DEPS)
...
$(META_BUILDX_TARGET): $(META_CREATE_BUILDER_TARGET) Dockerfile Makefile $(GRAVITY_DEPS)
